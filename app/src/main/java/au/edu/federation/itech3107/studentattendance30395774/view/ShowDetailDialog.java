...
import au.edu.federation.itech3107.studentattendance30395774.AddActivity;
...
public class ShowDetailDialog {
   ...
   public void show(final Activity activity, final CourseBean course,
...
//      tvClassroom.setText(course.getCouLocation());
   ...
   private void edit(Activity activity, CourseBean course) {
   ...
   @NonNull
   private StringBuilder getNodeInfo(CourseBean course) {
