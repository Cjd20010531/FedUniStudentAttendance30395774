...
//Curriculum schedule
@Entity
public class CourseBean extends CourseBaseBean implements Serializable {
    ...
    /**
     * name teacher location is equal to the same course
     */
    public boolean isSameClass(CourseBean other) {
        if (other == null) {
            return false;
        }
    ...
    /**
     * name teacher equals the same subject
     */
    public boolean isSameClassWithoutLocation(CourseBean other) {
        if (other == null) {
            return false;
        }
     ...
     * The onlyId is equal
     */
    public boolean onlyIdEqualsOnlyIdOf(CourseBean CourseBean) {
        if (CourseBean == null) {
            return false;
        }

        if (this.getCouOnlyId() == null || CourseBean.getCouOnlyId() == null) {
            return false;
        }
        return this.getCouOnlyId().equals(CourseBean.getCouOnlyId());
    }
    ...
    public CourseBean setCouIdReturn(int couId) {
        this.couId = couId;
        return this;
    }
    ...
    public CourseBean setCouWeekR(Integer couWeek) {
        this.couWeek = couWeek;
        return this;
    }
    ...
    public CourseBean setCouStartNodeR(Integer couStartNode) {
        this.couStartNode = couStartNode;
        return this;
    }
    ...
    public CourseBean setCouNodeCountR(Integer couNodeCount) {
        this.couNodeCount = couNodeCount;
        return this;
    }
    ...
    public CourseBean setCouAllWeekR(String couAllWeek) {
        this.couAllWeek = couAllWeek;
        return this;
    }
    ...
    public CourseBean setCouColorR(Integer couColor) {
        this.couColor = couColor;
        return this;
    }
    ...
    public CourseBean setCouCgIdR(Long couCgId) {
        this.couCgId = couCgId;
        return this;
    }
    ...
    public CourseBean setCouOnlyIdR(String couOnlyId) {
        this.couOnlyId = couOnlyId;
        return this;
    }
