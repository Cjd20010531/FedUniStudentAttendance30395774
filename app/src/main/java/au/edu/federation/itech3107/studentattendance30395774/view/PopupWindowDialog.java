...
public class PopupWindowDialog implements View.OnClickListener {
    ...
    public interface SelectTimeCallback {
        void onSelected(CourseBean course);
    }

    public void showSelectTimeDialog(Activity activity, final CourseBean course, final SelectTimeCallback callback) {
    ...
    private void show(Activity activity, final CourseBean course, final SelectTimeCallback callback, View view) {
